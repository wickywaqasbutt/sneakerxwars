...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
    ...
    <!-- simplebar styles -->
    <link rel="stylesheet" href="{{asset('dashboard-assets/css/vendor/simplebar.css')}}">
    <!-- favicon -->
  ...
  <body>
    ...
    <!-- app -->
    <script src="{{asset('dashboard-assets/js/utils/app.js')}}"></script>
    <!-- page loader -->
    <script src="{{asset('dashboard-assets/js/utils/page-loader.js')}}"></script>
    <!-- simplebar -->
    <script src="{{asset('dashboard-assets/js/vendor/simplebar.min.js')}}"></script>
    <!-- liquidify -->
    <script src="{{asset('dashboard-assets/js/utils/liquidify.js')}}"></script>
    <!-- XM_Plugins -->
    <script src="{{asset('dashboard-assets/js/vendor/xm_plugins.min.js')}}"></script>
    <!-- global.hexagons -->
    <script src="{{asset('dashboard-assets/js/global/global.hexagons.js')}}"></script>
    <!-- global.tooltips -->
    <script src="{{asset('dashboard-assets/js/global/global.tooltips.js')}}"></script>
    <!-- global.accordions -->
    <script src="{{asset('dashboard-assets/js/global/global.accordions.js')}}"></script>
    <!-- header -->
    <script src="{{asset('dashboard-assets/js/header/header.js')}}"></script>
    <!-- sidebar -->
    <script src="{{asset('dashboard-assets/js/sidebar/sidebar.js')}}"></script>
    <!-- content -->
    <script src="{{asset('dashboard-assets/js/content/content.js')}}"></script>
    <!-- form.utils -->
    <script src="{{asset('dashboard-assets/js/form/form.utils.js')}}"></script>
    <!-- SVG icons -->
    <script src="{{asset('dashboard-assets/js/utils/svg-loader.js')}}"></script>
