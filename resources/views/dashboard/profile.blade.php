...
@section('title', 'Vikinger | Account Hub')
@section('styling')
@endsection
@section('content')
  <!-- CONTENT GRID -->
  <div class="content-grid">
    ...
    <div class="section-banner">
      <!-- SECTION BANNER ICON -->
      <img class="section-banner-icon" src="{{ asset('dashboard-assets/img/banner/accounthub-icon.png') }}" alt="accounthub-icon">
      <!-- /SECTION BANNER ICON -->
          ...
          <div class="grid grid-3-3-3 centered">
            ...
            <div class="user-preview small fixed-height">
              ...
              <figure class="user-preview-cover liquid">
                <img src="{{ asset('dashboard-assets/img/cover/01.jpg') }}" alt="cover-01">
              </figure>
              <!-- /USER PREVIEW COVER -->
                ...
                <div class="user-short-description small">
                  ...
                  <div class="user-short-description-avatar user-avatar">
                    ...
                    <div class="user-avatar-content">
                      <!-- HEXAGON -->
                      <div class="hexagon-image-68-74" data-src="{{ asset('dashboard-assets/img/avatar/01.jpg') }}"></div>
                      <!-- /HEXAGON -->
                    </div>
                    <!-- /USER AVATAR CONTENT -->
              ...
              <div class="draggable-items">
                ...
                <div class="draggable-item">
                  ...
                  <div class="badge-item">
                    <img src="{{ asset('dashboard-assets/img/badge/gold-s.png') }}" alt="badge-gold-s">
                  </div>
                  <!-- /BADGE ITEM -->
                </div>
                <!-- /DRAGGABLE ITEM -->
                ...
                <div class="draggable-item">
                  <!-- BADGE ITEM -->
                  <div class="badge-item">
                    <img src="{{ asset('dashboard-assets/img/badge/age-s.png') }}" alt="badge-age-s">
                  </div>
                  <!-- /BADGE ITEM -->
                </div>
                <!-- /DRAGGABLE ITEM -->
                ...
                <div class="draggable-item">
                  <!-- BADGE ITEM -->
                  <div class="badge-item">
                    <img src="{{ asset('dashboard-assets/img/badge/caffeinated-s.png') }}" alt="badge-caffeinated-s">
                  </div>
                  <!-- /BADGE ITEM -->
                </div>
                <!-- /DRAGGABLE ITEM -->
                ...
                <div class="draggable-item">
                  <!-- BADGE ITEM -->
                  <div class="badge-item">
                    <img src="{{ asset('dashboard-assets/img/badge/warrior-s.png') }}" alt="badge-warrior-s">
                  </div>
                  <!-- /BADGE ITEM -->
                </div>
                <!-- /DRAGGABLE ITEM -->
                ...
                <div class="draggable-item">
                  <!-- BADGE ITEM -->
                  <div class="badge-item">
                    <img src="{{ asset('dashboard-assets/img/badge/traveller-s.png') }}" alt="badge-traveller-s">
                  </div>
                  <!-- /BADGE ITEM -->
                </div>
                <!-- /DRAGGABLE ITEM -->
                ...
                <div class="draggable-item">
                  <!-- BADGE ITEM -->
                  <div class="badge-item">
                    <img src="{{ asset('dashboard-assets/img/badge/scientist-s.png') }}" alt="badge-scientist-s">
                  </div>
                  <!-- /BADGE ITEM -->
                </div>
                <!-- /DRAGGABLE ITEM -->
                ...
                <div class="draggable-item">
                  <!-- BADGE ITEM -->
                  <div class="badge-item">
                    <img src="{{ asset('dashboard-assets/img/badge/ncreature-s.png') }}" alt="badge-ncreature-s">
                  </div>
                  <!-- /BADGE ITEM -->
                </div>
                <!-- /DRAGGABLE ITEM -->
                ...
                <div class="draggable-item">
                  <!-- BADGE ITEM -->
                  <div class="badge-item">
                    <img src="{{ asset('dashboard-assets/img/badge/mightiers-s.png') }}" alt="badge-mightiers-s">
                  </div>
                  <!-- /BADGE ITEM -->
                </div>
                <!-- /DRAGGABLE ITEM -->
                ...
                <div class="draggable-item">
                  <!-- BADGE ITEM -->
                  <div class="badge-item">
                    <img src="{{ asset('dashboard-assets/img/badge/phantom-s.png') }}" alt="badge-phantom-s">
                  </div>
                  <!-- /BADGE ITEM -->
                </div>
                <!-- /DRAGGABLE ITEM -->
                ...
                <div class="draggable-item">
                  <!-- BADGE ITEM -->
                  <div class="badge-item">
                    <img src="{{ asset('dashboard-assets/img/badge/collector-s.png') }}" alt="badge-collector-s">
                  </div>
                  <!-- /BADGE ITEM -->
                </div>
                <!-- /DRAGGABLE ITEM -->
                ...
                <div class="draggable-item">
                  <!-- BADGE ITEM -->
                  <div class="badge-item">
                    <img src="{{ asset('dashboard-assets/img/badge/bronzec-s.png') }}" alt="badge-bronzec-s">
                  </div>
                  <!-- /BADGE ITEM -->
                </div>
                <!-- /DRAGGABLE ITEM -->
                ...
                <div class="draggable-item">
                  <!-- BADGE ITEM -->
                  <div class="badge-item">
                    <img src="{{ asset('dashboard-assets/img/badge/silverc-s.png') }}" alt="badge-silverc-s">
                  </div>
                  <!-- /BADGE ITEM -->
                </div>
                <!-- /DRAGGABLE ITEM -->
                ...
                <div class="draggable-item">
                  <!-- BADGE ITEM -->
                  <div class="badge-item">
                    <img src="{{ asset('dashboard-assets/img/badge/goldc-s.png') }}" alt="badge-goldc-s">
                  </div>
                  <!-- /BADGE ITEM -->
                </div>
                <!-- /DRAGGABLE ITEM -->
